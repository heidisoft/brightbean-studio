...
class FacebookProvider(SocialProvider):
    ...
    def get_account_metrics(self, access_token: str, date_range: tuple[datetime, datetime]) -> AccountMetrics:
        ...
        page_impressions = self._get_optional_page_impression_metrics(access_token, page_id, date_range)
        return AccountMetrics(
            impressions=page_impressions.impressions,
            reach=page_impressions.reach,
            profile_views=values.get("page_views_total", 0),
            followers_gained=values.get("page_daily_follows", 0),
            extra={
                "views": values.get("page_video_views", 0),
                "raw_insights": values,
                "raw_page_impressions": page_impressions.extra.get("raw_page_impressions", {}),
            },
        )

    def _get_optional_page_impression_metrics(
        self,
        access_token: str,
        page_id: str,
        ...
        return AccountMetrics(
            ...
            extra={"raw_page_impressions": values},
        )
